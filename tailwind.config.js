    ...
    extend: {
      ...
      keyframes: {
        expandModalRightToLeft: {
          "0%": { width: "0", right: 0, top: "1.25rem" },
          "50%": { width: "100%", right: 0, top: "1.25rem" },
          "100%": { width: "100%", right: 0, top: "0" },
        },
        contractModalLeftToRight: {
          "0%": { width: "100%", right: 0, top: "0" },
          "50%": { width: "100%", right: 0, top: "1.25rem" },
          "100%": { width: "0", right: 0, top: "1.25rem" },
        },
        blur_screen: {
      ...
      animation: {
        ...
        contractModalLeftToRight:
          "contractModalLeftToRight 0.4s ease-out forwards",
