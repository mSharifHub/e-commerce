...
export default function CartIcon() {
  ...
  return (
    <div className=" flex justify-center items-centertransition-all duration-75 hover:scale-110 cursor-pointer w-10 h-10">
      <div className=" relative flex justify-between items-center space-x-4 z-20">
        <FontAwesomeIcon icon={faBagShopping} size="lg" />
        {shoppingCart.length > 0 ? (
          <div className="absolute top-0 -left-1/2 translate-x-1/3 bg-black w-8 h-4 rounded-full flex items-center justify-center whitespace-nowrap">
