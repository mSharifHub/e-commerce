  ...
  return (
    ...
    >
      <div
        ...
        className={` absolute top-1/2 -translate-y-1/2 left-[1rem]  sm:left-[5rem] md:left-[10rem]  lg:left-[15rem]  xl:left-[20rem]  transition-opacity duration-150 z-20 rounded-full w-8 h-8  flex justify-center items-center ${
      ...
      <div
        ...
        className={`absolute top-1/2 -translate-y-1/2 right-[1rem] sm:right-[5rem] md:right-[10rem] lg:right-[15rem] xl:right-[20rem] transition-opacity duration-150 z-20 rounded-full w-8 h-8  flex justify-center items-center ${
          isMouseOver ? "opacity-100 cursor-pointer" : "opacity-0"
        } hover:bg-slate-200`}
      >
        <ArrowRight />
