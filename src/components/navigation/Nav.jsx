...
export default function Nav() {
  return (
    <div className=" grid grid-rows-[0.2fr_1fr_1fr]  relative overflow-hidden">
      <div className=" absolute translate-y-[2rem]  sm:translate-y-0  inset-0   py-4 flex justify-end items-center row-start-1  row-span-1 transition-transform duration-500  whitespace-nowrap ">
        <NavMenu />
      </div>
